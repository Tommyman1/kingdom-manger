...
async def startup():
    asyncio.create_task(inventory_cache_loop()); asyncio.create_task(monitor_loop()); asyncio.create_task(trivy_auto_loop()); asyncio.create_task(score_history_loop()); asyncio.create_task(reporting_loop()); asyncio.create_task(update_engine_loop()); asyncio.create_task(drift_scan_loop()); asyncio.create_task(sensor_watch_loop())
