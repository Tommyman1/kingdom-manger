...
<div class="toolbar container-actions" onclick="event.stopPropagation()">
  ...
  <button class="btn-secondary btn-compact" onclick="checkUpdate('${esc(c.name)}')">Update</button>
</div>
