    ...
    for item in containers:
        ...
        if cr:
            ...
            if cr_ctx['suppressed']:
                ...
                factors.append(f"Known-good approval: original {original_cr_score} − {adj} = {cr_score} effective risk points ({scopes})")
...
def suppression_diagnostics_data() -> list[dict]:
    ...
    for sr in sups:
        ...
        if active and name:
            ...
            elif correlation_matches==0:
                blocker='Events match, but no recent stored correlation signal matched the approved rule'
        elif not active:
...
<div class="card containers"><h2 class="section-title">CONTAINER LIFE & CONTROLS</h2><div id="containers"></div></div><div class="footer"><span>🧠 Decision Engine <b class="good">Active</b></span><span>🛡 Versioned DB migrations</span><span id="footerEval">Last evaluation —</span><span>v1.11.2 · Trust Diagnostics + Scoring Consistency ♛</span></div></div>
<script>
